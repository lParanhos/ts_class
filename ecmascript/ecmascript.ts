...
const turmaA: string[] = ['miguel', 'ana', 'lorena'];
const turmaB: string[] = ['jonas', 'ruan', ...turmaA];
console.log(turmaB);
...
//Spread & rest (tupla)
const tupla: [number, string, boolean] = [10, 'TS', true];
...
// Exercicio 2
var dizerOla = function (nome?: string) : void {
